...
<body>
	<div class="row">
        <div class="col">
            <div class="card">
                <form class="issueboard-form" method="POST">
...
<%--                     <input type="hidden" name="mem_id" value="${MEMBER_LOGININFO.mem_id}"> --%>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="id" type="text" disabled id="example-search-input">
                    </div>
	...
	<script type="text/javascript">
		$('input[name=id]').val('${MEMBER_LOGININFO.mem_id}');
...
// 			const project_no = $('input[name=project_no]').val();
			...
			// 제목을 입력하지 않았을 때!
			const report_title = $('input[name=title]').val();
			...
			const $frm = $('form[class=issueboard-form]');
...
// 			$frm.append($ipt_mem_id);
			...
			$frm.attr('action', '${pageContext.request.contextPath}/user/reportboard/insertReportboard.do?project_no=${project_no}&mem_id=${MEMBER_LOGININFO.mem_id}');
			$frm.submit();
			
			//${pageContext.request.contextPath}/user/issueboard/insertIssueboard.do
			//데이터 넘겨서 Insert 작업하기
// 			location.href = '${pageContext.request.contextPath}/user/issueboard/insertIssueboard.do?issue_title=' + issue_title + '&issue_content=' + issue_content + '&mem_id=${MEMBER_LOGININFO.mem_id}' + '&project_no=' + project_no;
		...
		$('.btn-back').on('click', function() {
			location.href = '${pageContext.request.contextPath}/user/issueboard/issueboardList.do?project_no=${project_no}&mem_id=${MEMBER_LOGININFO.mem_id}'; 
		});
	</script>
</body>
</html>