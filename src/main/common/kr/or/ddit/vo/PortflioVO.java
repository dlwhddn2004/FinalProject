...
public class PortflioVO {
	...
	private String portfolio_categories;
	private String portfolio_tags;
	...
	public String getPortfolio_tags() {
		return portfolio_tags;
	}
	public String getPortfolio_technologies() {
		return portfolio_technologies;
	}
	...
	public String getPortfolio_enddate() {
		return portfolio_enddate;
	}
	public String getPortfolio_participationrate() {
		return portfolio_participationrate;
	}
	...
	public void setPortfolio_categories(String portfolio_categories) {
		this.portfolio_categories = portfolio_categories;
	}
	public void setPortfolio_tags(String portfolio_tags) {
		this.portfolio_tags = portfolio_tags;
	}
	public void setPortfolio_technologies(String portfolio_technologies) {
		this.portfolio_technologies = portfolio_technologies;
	}
	...
	public void setPortfolio_enddate(String portfolio_enddate) {
		this.portfolio_enddate = portfolio_enddate;
	}
	public void setPortfolio_participationrate(String portfolio_participationrate) {
		this.portfolio_participationrate = portfolio_participationrate;
	}
