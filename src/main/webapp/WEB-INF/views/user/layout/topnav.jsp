							...
							<a href="#!" class="list-group-item list-group-item-action">
								...
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<img alt="Image placeholder"
											src="${pageContext.request.contextPath }/assets/img/theme/team-3.jpg"
											class="avatar rounded-circle">
									</div>
									<div class="col ml--2">
										<div class="d-flex justify-content-between align-items-center">
								...
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<img alt="Image placeholder"
											src="${pageContext.request.contextPath }/assets/img/theme/team-4.jpg"
											class="avatar rounded-circle">
									</div>
									<div class="col ml--2">
										<div class="d-flex justify-content-between align-items-center">
								...
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<img alt="Image placeholder"
											src="${pageContext.request.contextPath }/assets/img/theme/team-5.jpg"
											class="avatar rounded-circle">
									</div>
									<div class="col ml--2">
										<div class="d-flex justify-content-between align-items-center">
