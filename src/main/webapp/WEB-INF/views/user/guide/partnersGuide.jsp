        ...
        <div class="col-lg-4">
          <div class="card">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item bg-gradient-success text-white">디벨로퍼 이용방법</li>
            ...
            <div class="card-body">
				<div class="form-group">
					<h2>
              		...
              		<p class="mx-2">간단하게 프로젝트 내용을 등록하면,<br>수많은 지원자들의 견적과 지원 내용을 빠르게 받아볼 수 있습니다.</p>
              		<img class="guide_img" alt="" src="${pageContext.request.contextPath}/assets/img/guide/p_guide_1.PNG">                  
                </div>
				<div class="form-group">
					<h2>
