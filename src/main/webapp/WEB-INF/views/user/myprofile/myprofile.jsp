              ...
              <form>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" placeholder="Username" value="deokdeoks">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="password" id="input-first-name" class="form-control" placeholder="" value="Lucky">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">password confirm</label>
                        <input type="password" id="input-last-name" class="form-control" placeholder="" value="Jesse">
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden"  class="form-control" name="mem_hp" id="input-last-name" /><br>
                         <select 
                        name="mem_hp1">
                ...
                <div class="col-lg-6">
                      <div class="zip">
                        ...
                        <input type="hidden"  class="form-control" name="mem_bir" id="input-last-name" /><br>
                        <input type="text" id="mem_zip" name="mem_zip" size="8" value="시"/> 
                        <input type="text" id="mem_zip2" name="mem_zip2" size="8" value="군/구"/> 
                         <input type="text" id="mem_zip3" name="mem_zip3" size="8" value=""/> 
                         
                         <br><br>
    				    <button type="button"  class="btn btn-primary btn-write" style="float:right";>수정</button>
