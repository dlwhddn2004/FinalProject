...
<body>
	<div class="row">
        <div class="col">
            <div class="card">
                <form class="successboard-form" action="${pageContext.request.contextPath }newsboardInsert.do" method="POST">
                    <div class="form-group">
                    
                        <label for="example-text-input" class="form-control-label">제목</label>
                        <input class="form-control" type="text" name="news_title" id="example-text-input">
                    </div>
                    <div class="form-group">
	...
	<script type="text/javascript">
		...
		$(".form-button-area .btn-submit").on("click", function() {
			...
			// 데이터 넘겨서 Insert 작업하기
			location.href = '${pageContext.request.contextPath}/user/newsboard/newsboardInsert.do?news_title=' + news_title + "&news_content=" + news_content + "&mem_id=${MEMBER_LOGININFO.mem_id}";
		});
