        ...
        <div class="col">
            <div class="card here">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="report_title" id="example-text-input" readonly>
                </div>
                <div class="form-group">
...
<!-- 		      </div> -->
	...
	$('.comment-write-area').hide();
		...
		$('input[name=report_title]').val('${reportInfo.REPORT_TITLE}');
		$('input[name=mem_id]').val('${reportInfo.MEM_ID}');
