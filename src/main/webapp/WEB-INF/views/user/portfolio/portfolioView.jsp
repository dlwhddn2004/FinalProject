...
<body>
	...
	<script
		src="${pageContext.request.contextPath}/assets/vendor/quill/dist/quill.min.js"></script>
	<script
	...
	let developScore;
		...
		$(function() {
			...
			const
			contentSmall = contentScore.charAt(0);
		...
		function portfolioLike() {
			...
			const
			portfolio_no = '${portfolioInfo.PORTFOLIO_NO}';
			$
					.ajax({
						type : 'POST',
