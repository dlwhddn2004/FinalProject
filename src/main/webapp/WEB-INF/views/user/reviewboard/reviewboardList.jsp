...
// 			}
			...
			// 로그인 한 상태!
// 			location.href = "${pageContext.request.contextPath}/user/reviewboard/reviewForm.do?mem_id=${MEMBER_LOGININFO.mem_id}";
// 		});
// 	});
	
// 	function viewBoardInfo(e) {
// 		const success_no = $(e).find('input[name=review_no]').val();
// 		const mem_id = $(e).find('input[name=mem_id]').val();
		
// 		location.href = "${pageContext.request.contextPath}/user/reviewboard/reviewboardView.do?review_no=" + review_no + "&mem_id=${MEMBER_LOGININFO.mem_id}";
// 	}
	$(function() {
		$('.btn-write').on('click', function() {
			//로그인 안했을 때 알림
